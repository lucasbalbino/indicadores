(function () {
    ...
    /** @ngInject */
    function DevSuporteCtrl($scope, DesenvolvimentoSuporteService) {

        $scope.query = DesenvolvimentoSuporteService.getChamadosXAtividadesTable();
        ...
        $scope.columnsDefs = [
            {
                ...
                "render": function (data) {
                    ...
                    return '<div class="tabela-dev-suporte">' +
                        '<a target="_blank" href="http://LINK?dados=' + atividade + '">' + data + '</a>' + '</div>';
                }
            }, {
                "targets": 6,
                "render": function (data) {
