(function () {
    ...
    app
        .controller('UsuAlterarFotoCtrl', UsuAlterarFotoCtrl)
        .controller('ModalInstanceAlterarFotoCtrl', ModalInstanceAlterarFotoCtrl)

    /** @ngInject */
    function UsuAlterarFotoCtrl($rootScope, $scope, $http, $state, $uibModal, $log) {
    ...
    /** @ngInject */
    function ModalInstanceAlterarFotoCtrl($rootScope, $scope, $uibModalInstance, $http, $timeout, Upload, usuario, ENV) {
