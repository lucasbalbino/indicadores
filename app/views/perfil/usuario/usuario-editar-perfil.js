'use strict';
app
    .controller('UsuEditarPerfilCtrl', [
        '$rootScope', '$scope', '$http', '$state', '$uibModal', '$log', '$timeout', 'Upload', 'ENV',
        function ($rootScope, $scope, $http, $state, $uibModal, $log, $timeout, Upload, ENV) {
...
app.controller('ModalInstanceEditarPerfilCtrl', function ($scope, $uibModalInstance, usuario) {
