( function() {
    ...
    SupAvaliacaoChamadosPorColaboradorCtrl.$inject = ['$rootScope', '$scope', 'ENV']

    function SupAvaliacaoChamadosPorColaboradorCtrl($rootScope, $scope, ENV) {
        var mes = moment($rootScope.mes);

        $scope.query = {
            url: ENV.API_ENDPOINT + '/avaliacaoChamadosPorColaborador',
            data: {
