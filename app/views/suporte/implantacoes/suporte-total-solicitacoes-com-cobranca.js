( function() {
    ...
    SupTotalSolicitacoesComCobrancaCtrl.$inject = ['$scope', '$rootScope', '$http', 'ENV']

    function SupTotalSolicitacoesComCobrancaCtrl($scope, $rootScope, $http, ENV) {
        var QTD_MESES = 4;
        var dadosTemp = [];
        var totais = [];
        ...
        function totalSolicitacoesComCobranca(dataInicial, dataFinal, callback) {
            $http.get(ENV.API_ENDPOINT + '/valoresCamposAdicionais', {
                params: {
