            ...
            link: function (scope, el, attr) {
                el.on('click', function () {
					...
					if($("#sidebar").hasClass("menu-compact")) {
                        $("#logotipo").show();
						$(".navbar .sidebar-collapse").css("left", "189px");
					}
					else {
						$("#logotipo").hide();
						$(".navbar .sidebar-collapse").css("left", "5px");
					}
					// FIM
...
angular.module('app')
    .directive('setting', function () {
        return {
            restrict: 'AC',
            template: '<a id="btn-setting" title="Opções" href="javascript:;"><i class="icon fa fa-cog"></i></a>',
            link: function (scope, el, attr) {
                el.on('click', function () {
